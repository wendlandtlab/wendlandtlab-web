...
<template>
  <div class="flex flex-col min-h-screen">
    <HeaderMenu />
    <div class="flex-grow">
      <div class="container mx-auto px-5 max-w-screen-xl">
        <div class="flex flex-col mx-auto sm:flex-row align-middle px-5">
          ...
          <div class="text-justify flex-grow text-md text-gray-600 pb-3">
            <p>
              ...
              the synthesis of bio-relevant molecules. To illustrate this, we
              have outlined our research areas from each of these two lenses.
            </p>
          </div>
        </div>
