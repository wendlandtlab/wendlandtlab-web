              ...
              <PopoverPanel class="absolute z-10 -ml-4 mt-3 transform px-2 w-screen max-w-md sm:px-0 lg:ml-0 lg:left-1/2 lg:-translate-x-1/2">
                <div class="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden">
                  <div class="relative grid gap-6 bg-white px-5 py-6 sm:gap-8 sm:p-8">
                    <a v-for="item in research" :key="item.name" :href="item.href" class="-m-3 p-3 flex items-start rounded-lg hover:bg-gray-50">
          ...
          <div class="pt-5 pb-6 px-5">
            ...
            <div class="mt-6">
              <nav class="grid grid-cols-2 gap-y-8">
                <a v-for="item in research" :key="item.name" :href="item.href" class="-m-3 p-3 flex items-center rounded-md hover:bg-gray-50">
                  <component :is="item.icon" class="flex-shrink-0 h-6 w-6 text-indigo-600" aria-hidden="true" />
...
const research = [
  {
    ...
    description: 'Selective catalysis and mechanistic understanding',
    href: 'Research',
    icon: ChartBarIcon,
  },
  {
    name: 'Sugar editing',
    description: 'Selective editing of minimally protected glycans',
    href: '#',
    icon: ChartBarIcon,
  },
  {
    name: 'Isomerization editing',
    description: 'New strategies for setting and changing stereocenters',
    href: '#',
    icon: CursorClickIcon,
  },
  { name: 'Transition metal catalysis', 
    description: "Transition metal mediated radical reactivity",
    href: '#', 
